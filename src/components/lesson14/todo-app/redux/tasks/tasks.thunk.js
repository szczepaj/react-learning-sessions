...
// export const fetchTasksThunk = () => async (dispatch, getState) => {
//     dispatch(getTasksAction())
//     try {
//         const response = await getTasks(true)
//         const { tasks } = response
//         dispatch(getTasksSuccessful(tasks))
//     } catch (e) {
//         dispatch(getTasksRejected('There was a problem while fetching'))
